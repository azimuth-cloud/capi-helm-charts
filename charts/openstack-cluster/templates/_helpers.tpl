...
{{/*
Validates addons.hostedControlPlane matches the control plane type and that Kamaji
is not combined with unsupported node-level features.
*/}}
...
webhook. $dir is the mount directory holding the CA file.
...
$dir is the mount directory holding the referenced webhook kubeconfig.
*/}}
